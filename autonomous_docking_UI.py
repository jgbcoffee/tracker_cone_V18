...
######################NEUTRAL_POSITION = [89.7, -250, 360, 0.96, -0.26, 0.08]
...
#mc.send_coords(NEUTRAL_POSITION, 5, 1)
...
canvas_title.grid(column=0, row=0, columnspan=2)
...
canvas_all_centers.grid(column=0, row=3)
...
canvas_track_path.grid(column=1, row=3)
